...
class FoundPerfil extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => FoundPerfilState();
}

class FoundPerfilState extends State<FoundPerfil> {
  File imageFile;
  ...
  Future<void> _getUserData() async {
    ...
    var documento = await Firestore.instance
        .collection('usuarios')
        .where('personId', isEqualTo: thenumberfinal)
        .getDocuments();

    setState(() {
      this.nome = documento.documents[0].data['nome'];
      this.facebook = documento.documents[0].data['facebook'];
      this.instagram = documento.documents[0].data['instagram'];
      this.twitter = documento.documents[0].data['twitter'];
      this.foto = documento.documents[0].data['foto'];
      this.personId = documento.documents[0].data['personId'];
